...
import { FaLinkedin, FaGithub, FaEnvelope, FaCheckCircle } from "react-icons/fa";
import { BsTwitterX } from "react-icons/bs";

import { ReactTyped } from 'react-typed';
import { profile } from '../data/profile';
import { motion } from 'framer-motion';
import profilePic from '../Assets/prajwal.png';
...
const About = () => {
  return (
    <section
      id="about"
      className="container min-h-screen py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex items-center">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 w-full">
        <motion.div
          ...
          <div className="mt-6 grid gap-3">
            {[
              "End‑to‑end delivery: frontend, backend and cloud",
              "Production‑grade APIs and microservices",
              "Security, performance and DX as first‑class concerns",
            ].map((h, i) => (
              <motion.div
                key={i}
